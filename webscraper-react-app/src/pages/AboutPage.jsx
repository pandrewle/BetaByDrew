...
function AboutPage() {
  return (
    <div
      className="aboutpage-container flex flex-col gap-8 items-center lg:items-center lg:justify-start py-4"
      id="about"
    >
      <div className="about-section flex flex-col gap-4 items-center md:px-16 px-8">
        ...
        <p className="text-2xl bg-purple-500 text-slate-200 text-center w-full font-medium">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 px-2">
          ...
          >
            <img
              ...
              alt="REI"
              className="aspect-auto w-[100px] h-[80px] lg:w-[160px] lg:h-[140px] object-contain py-4"
              loading="lazy"
            />
          </a>
          <a
      ...
      <div className="w-full flex flex-col gap-8 justify-center items-center lg:flex-row mt-4 rounded-sm bg-primaryaccent lg:px-48 md:px-16 md:py-4 py-8 px-8">
        <div className="lg:w-1/2 flex flex-col gap-4 justify-center items-center relative py-4">
          <h1 className="text-5xl font-bold text-slate-200 text-center">
            FROM THE CREATOR
          </h1>
          <p className="text-2xl font-medium text-slate-200 text-center w-[100%] mt-4">
        ...
        <div className="lg:w-1/2 flex flex-col gap-8 justify-center items-center relative">
          <div className="lg:h-[500px] p-4">
            <img
              src="/assets/DrewPortrait.JPG"
              alt="Andrew"
              className="w-full h-full object-contain rounded-md lg:py-0"
            />
          </div>
        </div>
      </div>
      ...
      <p className="text-2xl font-medium text-slate-200 text-center w-[70%] ">
        As my first personal project, I hold a deep passion for Beta, so I will
        continue to build upon it. Please let me know any suggestions you have!
      </p>
